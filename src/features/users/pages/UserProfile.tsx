  ...
  return (
    <div className="max-w-[900px] mx-auto px-4 py-8">
      <PixelFrame className="mb-6">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="font-pixel text-[9px] text-accent pixel-text-shadow mt-1">{user.title}</p>
            <p className="text-lg text-muted-foreground mt-1">Joined {user.joinedDate}</p>
          </div>
          ...
          <div className="pixel-border bg-secondary px-6 py-3 text-center">
            ...
            <p className="font-pixel text-[22px] text-accent pixel-text-shadow">{user.level}</p>
          </div>
        </div>
      </PixelFrame>
      ...
      <PixelFrame className="mb-6">
        ...
        <a href={user.githubUrl} target="_blank" rel="noopener noreferrer" className="text-xl text-accent hover:text-foreground">
          {user.githubUrl}
        </a>
      </PixelFrame>
