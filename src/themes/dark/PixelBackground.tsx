  ...
  const [particles] = useState(() =>
    Array.from({ length: 20 }).map((_, i) => {
      ...
      return {
        ...
        color: isSpark
          ? (Math.random() > 0.5 ? "#f1c40f" : "#e67e22")
          : (Math.random() > 0.5 ? "#7f8c8d" : "#ecf0f1"),
  ...
  return (
    <div className="pixel-bg" aria-hidden="true">
      {isShopPage ? (
        ...
        >
          <defs>
            <pattern id="dk_shop_woodWall" width="64" height="64" patternUnits="userSpaceOnUse">
            ...
            <pattern id="dk_shop_counterWood" width="32" height="32" patternUnits="userSpaceOnUse">
              <rect width="32" height="32" fill="#4A2E1B" />
              <rect x="0" y="0" width="32" height="4" fill="#5C3A21" />
              <rect x="0" y="16" width="32" height="4" fill="#3D2616" />
            </pattern>
            <radialGradient id="dk_shop_lanternGlow" cx="0.5" cy="0.5" r="0.5">
            ...
            <radialGradient id="dk_shop_centerVignette" cx="0.5" cy="0.5" r="0.75">
              <stop stopColor="#1A0F09" stopOpacity="0.4" />
              <stop offset="1" stopColor="#0A0604" stopOpacity="0.8" />
            </radialGradient>
            <symbol id="dk_shop_lantern" viewBox="-20 -10 40 60">
            ...
            <symbol id="dk_shop_potion_red" viewBox="-20 -20 40 40">
            ...
            <symbol id="dk_shop_potion_blue" viewBox="-20 -20 40 40">
              <rect x="-4" y="-16" width="8" height="6" fill="#D97706" />
              <rect x="-6" y="-10" width="12" height="4" fill="#9CA3AF" />
            ...
            <symbol id="dk_shop_potion_green" viewBox="-20 -20 40 40">
              <rect x="-4" y="-16" width="8" height="6" fill="#D97706" />
              <rect x="-6" y="-10" width="12" height="4" fill="#9CA3AF" />
            ...
            <symbol id="dk_shop_goldBag" viewBox="-20 -15 40 35">
            ...
            <symbol id="dk_shop_goldCoins" viewBox="-15 -10 30 20">
            ...
            <symbol id="dk_shop_spellBook" viewBox="-10 -25 50 40">
          ...
          <rect width="1600" height="900" fill="url(#dk_shop_woodWall)" />
          ...
          <use href="#dk_shop_potion_red" x="60" y="246" width="40" height="40" transform="scale(1.5) translate(-20, -10)" />
          <use href="#dk_shop_potion_red" x="100" y="246" width="40" height="40" transform="scale(1.5) translate(-46, -10)" />
          <use href="#dk_shop_spellBook" x="40" y="496" width="50" height="40" transform="scale(1.5) translate(-20, -52)" />
          <use href="#dk_shop_potion_blue" x="140" y="496" width="40" height="40" transform="scale(1.5) translate(-86, -55)" />
          <use href="#dk_shop_potion_green" x="1480" y="246" width="40" height="40" transform="scale(1.5) translate(-493, -10)" />
          <use href="#dk_shop_goldBag" x="1460" y="496" width="40" height="35" transform="scale(1.5) translate(-480, -60)" />
          <use href="#dk_shop_goldCoins" x="1500" y="496" width="30" height="20" transform="scale(1.5) translate(-506, -112)" />
          <g transform="translate(0, 750)">
            <rect width="1600" height="150" fill="url(#dk_shop_counterWood)" />
            <rect width="1600" height="16" fill="#784421" />
            <rect y="16" width="1600" height="8" fill="#2C1A10" opacity="0.5" />
            <use href="#dk_shop_goldBag" x="300" y="-4" width="40" height="35" transform="scale(2) translate(-150, 0)" />
            <use href="#dk_shop_goldCoins" x="380" y="0" width="30" height="20" transform="scale(2) translate(-190, -4)" />
            <use href="#dk_shop_spellBook" x="1250" y="-4" width="50" height="40" transform="scale(1.5) translate(-833, 0)" />
          </g>
          <rect x="100" y="0" width="8" height="100" fill="#1F2937" />
          <use href="#dk_shop_lantern" x="104" y="100" width="40" height="60" transform="scale(1.5) translate(-34, -33)" />
          <rect x="54" y="50" width="600" height="600" fill="url(#dk_shop_lanternGlow)" pointerEvents="none" />
          <rect x="1480" y="0" width="8" height="100" fill="#1F2937" />
          <use href="#dk_shop_lantern" x="1484" y="100" width="40" height="60" transform="scale(1.5) translate(-989, -33)" />
          <rect x="1000" y="50" width="600" height="600" fill="url(#dk_shop_lanternGlow)" pointerEvents="none" />
          <rect width="1600" height="900" fill="url(#dk_shop_centerVignette)" pointerEvents="none" />
        </svg>
      ) : isHomePage ? (
        ...
        >
          ...
          >
            <defs>
              <pattern id="dk_deep_stoneRow" width="96" height="48" patternUnits="userSpaceOnUse" shapeRendering="crispEdges">
              ...
              <pattern id="dk_deep_wallGrunge" width="256" height="256" patternUnits="userSpaceOnUse" shapeRendering="crispEdges">
              ...
              <linearGradient id="dk_deep_depthShadow" x1="800" y1="0" x2="800" y2="2400" gradientUnits="userSpaceOnUse">
              ...
              <radialGradient id="dk_deep_torchGlow" cx="0.5" cy="0.5" r="0.5">
              ...
              <radialGradient id="dk_deep_agedTorchGlow" cx="0.5" cy="0.5" r="0.5">
              ...
              <radialGradient id="dk_deep_magmaGlow" cx="0.5" cy="1" r="0.6">
              ...
              <symbol id="dk_deep_pixelSkull" viewBox="0 0 32 32">
              ...
              <symbol id="dk_deep_pixelRoots" viewBox="0 0 20 80">
              ...
              <symbol id="dk_deep_magmaCracks" viewBox="0 0 64 64">
                <g shapeRendering="crispEdges">
              ...
              <symbol id="dk_deep_pixelTorch" viewBox="-20 -40 40 100">
                <g shapeRendering="crispEdges">
              ...
              <symbol id="dk_deep_pixelTorchAged" viewBox="-20 -40 40 100">
                <g shapeRendering="crispEdges">
            ...
            <rect width="1600" height="2400" fill="url(#dk_deep_stoneRow)" />
            <rect width="1600" height="2400" fill="url(#dk_deep_wallGrunge)" />

            <use href="#dk_deep_pixelRoots" x="150" y="600" width="20" height="80" transform="scale(1.5)" />
            <use href="#dk_deep_pixelRoots" x="1400" y="750" width="20" height="80" transform="scale(2)" />
            <use href="#dk_deep_pixelRoots" x="1250" y="650" width="20" height="80" transform="scale(1.2)" />

            <use href="#dk_deep_pixelSkull" x="250" y="1100" width="32" height="32" transform="scale(2)" />
            <use href="#dk_deep_pixelSkull" x="300" y="1450" width="32" height="32" transform="scale(1.5)" />
            <use href="#dk_deep_pixelSkull" x="1350" y="1050" width="32" height="32" transform="scale(2.5)" />
            <use href="#dk_deep_pixelSkull" x="1200" y="1300" width="32" height="32" transform="scale(2)" />

            <use href="#dk_deep_magmaCracks" x="200" y="2100" width="64" height="64" transform="scale(4)" />
            <use href="#dk_deep_magmaCracks" x="1200" y="1950" width="64" height="64" transform="scale(3) scale(-1, 1)" />
            <use href="#dk_deep_magmaCracks" x="850" y="2250" width="64" height="64" transform="scale(5)" />

            <rect width="1600" height="2400" fill="url(#dk_deep_depthShadow)" pointerEvents="none" />

            <rect x="20" y="10" width="400" height="400" fill="url(#dk_deep_torchGlow)" pointerEvents="none" />
            <use href="#dk_deep_pixelTorch" x="220" y="210" width="40" height="100" />
            <rect x="1180" y="10" width="400" height="400" fill="url(#dk_deep_torchGlow)" pointerEvents="none" />
            <use href="#dk_deep_pixelTorch" x="1380" y="210" width="40" height="100" />

            <rect x="0" y="650" width="300" height="300" fill="url(#dk_deep_agedTorchGlow)" pointerEvents="none" />
            <use href="#dk_deep_pixelTorchAged" x="150" y="800" width="40" height="100" />
            <rect x="1250" y="850" width="300" height="300" fill="url(#dk_deep_agedTorchGlow)" pointerEvents="none" />
            <use href="#dk_deep_pixelTorchAged" x="1400" y="1000" width="40" height="100" />

            <rect x="0" y="1600" width="1600" height="800" fill="url(#dk_deep_magmaGlow)" pointerEvents="none" />
        ...
        >
          <defs>
            <linearGradient id="dk_cave_bg" x1="800" y1="0" x2="800" y2="900" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#171410" />
              <stop offset="0.45" stopColor="#12100d" />
              <stop offset="1" stopColor="#090b09" />
            </linearGradient>
            <radialGradient id="dk_cave_centerGlow" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(800 270) rotate(90) scale(260 700)">
              <stop stopColor="#422416" />
              <stop offset="1" stopColor="#422416" stopOpacity="0" />
            </radialGradient>
            <radialGradient id="dk_cave_torchGlowL" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(220 210) rotate(90) scale(220 260)">
            ...
            <radialGradient id="dk_cave_torchGlowR" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(1380 210) rotate(90) scale(220 260)">
              <stop stopColor="#C25317" stopOpacity="0.35">
                <animate attributeName="stop-opacity" values="0.4; 0.25; 0.45; 0.3; 0.4" dur="2.1s" repeatCount="indefinite" />
              </stop>
              <stop offset="1" stopColor="#C25317" stopOpacity="0" />
            </radialGradient>
            <symbol id="dk_cave_pixelTorch" viewBox="-20 -40 40 100">
              <rect x="-16" y="20" width="32" height="36" fill="#374151" stroke="#1A1612" strokeWidth="4" />
            ...
            <pattern id="dk_cave_pixelNoise" width="12" height="12" patternUnits="userSpaceOnUse">
            ...
            <pattern id="dk_cave_stoneRow" width="96" height="48" patternUnits="userSpaceOnUse">
              <rect width="96" height="48" fill="#16130F" />
              <rect x="0" y="0" width="48" height="24" fill="#1A1612" />
              <rect x="48" y="0" width="48" height="24" fill="#14110D" />
              <rect x="16" y="24" width="48" height="24" fill="#191510" />
            ...
            <linearGradient id="dk_cave_floor" x1="800" y1="620" x2="800" y2="900" gradientUnits="userSpaceOnUse">
              <stop stopColor="#0E110D" />
              <stop offset="1" stopColor="#090A08" />
            </linearGradient>
            <pattern id="dk_cave_floorTile" width="64" height="64" patternUnits="userSpaceOnUse">
          ...
          <rect width="1600" height="900" fill="url(#dk_cave_bg)" />
          <rect width="1600" height="900" fill="url(#dk_cave_pixelNoise)" opacity="0.55" />
          <rect width="1600" height="520" fill="url(#dk_cave_stoneRow)" opacity="0.55" />
          <g>
            <rect width="1600" height="900" fill="url(#dk_cave_centerGlow)" opacity="0.8" />
            <rect width="1600" height="900" fill="url(#dk_cave_torchGlowL)" />
            <rect width="1600" height="900" fill="url(#dk_cave_torchGlowR)" />
          </g>
          <use href="#dk_cave_pixelTorch" x="220" y="210" width="40" height="100" />
          <use href="#dk_cave_pixelTorch" x="1380" y="210" width="40" height="100" />
          <rect x="0" y="620" width="1600" height="280" fill="url(#dk_cave_floor)" />
          <rect x="0" y="620" width="1600" height="280" fill="url(#dk_cave_floorTile)" opacity="0.55" />
...
export default PixelBackgroundDark;
